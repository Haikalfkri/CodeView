...
if (!apiKey || !apiSecret) {
    console.error("STREAM_API_KEY or STREAM_API_SECRET are missing.");
}

export const streamClient = new StreamClient(apiKey, apiSecret); // will be for video call features
